    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                foreach ($data as $row) {
                    echo $row->username . "<div><button class='btn btn-success '> rubah<a href='" . $row->urlSetting . "'>" . $row->caption . "</a></button><div><br>";
                } ?>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Pelayanan Kepolisian <?= date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
